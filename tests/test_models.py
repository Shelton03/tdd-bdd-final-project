...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_with_bad_available_type(self):
        ...
        bad_data["available"] = "not-a-bool"
        self.assertRaises(DataValidationError, product.deserialize, bad_data)

    def test_deserialize_with_missing_key(self):
    ...
    def test_deserialize_with_bad_data(self):
        """It should raise DataValidationError when bad data is passed"""
        from service.models import DataValidationError
        product = ProductFactory()
        product.create()
    ...
    def test_deserialize_with_invalid_category(self):
        ...
        product.create()
        bad_data = product.serialize()
        bad_data["category"] = "INVALID_CATEGORY"
        self.assertRaises(DataValidationError, product.deserialize, bad_data)
